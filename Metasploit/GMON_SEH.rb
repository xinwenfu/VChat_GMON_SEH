...
##
# File path: /usr/share/metasploit-framework/modules/exploit/windows/VChat/GMON_SEH.rb
##
# This module exploits the GMON command of vulnerable chat server exploit the Structured Exception Handling in Windows.
##
